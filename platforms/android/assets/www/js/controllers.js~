...
result.password=password;
	      ...
	      url: host+'/signin',
				...
				window.localStorage.setItem("email", obj_data.email);
...
.controller('ChatDetailCtrl', function($scope, $stateParams,$ionicLoading,chatappdb,socket, $rootScope, $ionicPlatform, $cordovaLocalNotification , $ionicScrollDelegate , $timeout) {
...
$ionicLoading.show({
 ...
 chatappdb.gethistory(data.email,data.display_name).then(function(result) {
